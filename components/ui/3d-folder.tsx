...
const ImageLightbox: React.FC<ImageLightboxProps> = ({
    ...
    return createPortal(
        <div
            className={cn("fixed inset-0 z-[99999] flex items-center justify-center p-4 md:p-8")}
            onClick={handleClose}
            style={{
                    ...
                    >
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div className="flex-1 min-w-0">
                                ...
                                {currentProject?.description && <p className="text-muted-foreground mt-1 text-sm line-clamp-2">{currentProject.description}</p>}
                            ...
                            {currentProject?.link && (
                                <Link
                                    ...
                                    target="_blank"
                                    className={cn("flex items-center gap-2 px-6 py-3 text-sm font-bold uppercase tracking-widest text-primary-foreground bg-primary hover:brightness-110 rounded-xl shadow-lg shadow-primary/20 transition-all duration-300 hover:scale-105 active:scale-95 text-center justify-center")}
                                >
